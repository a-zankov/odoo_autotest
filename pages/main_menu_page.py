...
class MainMenuPage(BasePage):
    ...
    def open_proforma_page(self):
        crm_app_button = self.browser.find_element(*MainPageLocators.SALES_APP)
        crm_app_button.click()
    ...
    def click_all_apps(self, link):
        ...
        for i in apps_name:
            ...
            while True:
                ...
                back_to_main.click()
                app_elem = self.browser.find_element(By.CSS_SELECTOR, '[class="o_app o_menuitem"]')
